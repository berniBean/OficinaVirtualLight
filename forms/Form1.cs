...
namespace WindowsFormsApp6
{
    public partial class Form1 : Form
    {
        ...
        private void CargarRequerimientos()
        {
            ...
            if (toolStripTextBusqueda.Enabled == false)
                toolStripTextBusqueda.Enabled = true;
        ...
        private  void busquedaMasiva()
        {
            listReq = obReq.ListaBusquedaMasiva(lblEmision.Text, cmbOHE.Text);//bdReq.GetListaBusquedaMasiva(lblEmision.Text, cmbOHE.Text);
            cListaRequeridosBOBindingSource.DataSource = listReq;
            DgReqActivos2.DataSource = cListaRequeridosBOBindingSource;
        ...
        {
            if (DgReqActivos2.CurrentCell.ColumnIndex != 5|| DgReqActivos2.CurrentCell.ColumnIndex != 8|| DgReqActivos2.CurrentCell.ColumnIndex != 10)
            {
                try
                {
        ...
        {
            if (DgReqActivos2.CurrentCell.ColumnIndex == 5 || DgReqActivos2.CurrentCell.ColumnIndex == 8 || DgReqActivos2.CurrentCell.ColumnIndex == 12 || DgReqActivos2.CurrentCell.ColumnIndex==14)
            {
                e.Handled = false;
            }
            else {
        ...
        private void DgReqActivos2_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            int tipo = 1;
            pdfGestor vistaPDf = new pdfGestor(tipo,numReq,RFC,rs,idSAT,diligencia, uri,emision,ohe);
            vistaPDf.ShowDialog();
        }
