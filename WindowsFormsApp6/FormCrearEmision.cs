...
namespace WindowsFormsApp6
{
    public partial class FormCrearEmision : Form
    {
        ...
        private async Task<RestResponse> ActualizarDireccionesOmisosAsync(Datos dto)
        {
            ...
            var response = await RequestGenerico.PutAsync(sb.ToString(), body);
            return response;
        }
        ...
        private async void BtnEjecutar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //await AgregarRegistrosRequerimientosAsync(dto);
                //await AtualizaNumeracionRegistrosListadoRequerimientosAsync(dto);
