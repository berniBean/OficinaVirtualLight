...
{
    public class ToExcelAsync : AbstractProgress, IWriter<IEnumerable<CListaRequeridosBO>>
    {
        ...
        public ToExcelAsync(ToolStripProgressBar progressBar, ToolStripStatusLabel tsStatus, Label lblProgress, ExcelDataDto datos)
        {
        ...
        public async Task WriterAsync(IEnumerable<CListaRequeridosBO> data)
        {
            ...
            await MakeExcelAsync(data.ToList(), reportarProgreso);
        }

        private async Task MakeExcelAsync(List<CListaRequeridosBO> listaRequerimientos, IProgress<int> progress = null)
        {
