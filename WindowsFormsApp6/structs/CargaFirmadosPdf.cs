...
{
    public class CargaFirmadosPdf : AbstractProgress
    {
        ...
        public CargaFirmadosPdf()
        {

        }

        public CargaFirmadosPdf(ToolStripProgressBar progressBar, obtenerPDFSql listadoPDF, int tipoSesion)
        {
