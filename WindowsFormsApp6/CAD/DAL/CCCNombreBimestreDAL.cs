...
{
    class CCCNombreBimestreDAL : obtenerNombreBimestre
    {
        private readonly string strConn;
        private readonly Login lg = new Login();


        public CCCNombreBimestreDAL()
        {
            strConn = System.Configuration.ConfigurationManager.AppSettings["K1"];
        }

        public CCCNombreBimestreDAL(string conn)
        {
            strConn = conn;
        }
        ...
        public ListaCNombreBimestre GetNombreEmisionInforme(string ahno, string periodo )
        {
            ...
            try
            {
                ...
                {
                    MySqlCommand OrdenSql = new MySqlCommand("getNombreEmision", conn)
                    {
