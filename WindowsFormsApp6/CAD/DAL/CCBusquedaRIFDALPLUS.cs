...
{
    public class CCBusquedaRIFDALPLUS : obtenerBusqueda
    {
        private readonly string strConn;

        public CCBusquedaRIFDALPLUS()
        {
            strConn = System.Configuration.ConfigurationManager.AppSettings["K1"];
        }

        public CCBusquedaRIFDALPLUS(string conn)
        {
            strConn = conn;
        }
        ...
        public ListaCBusquedaRIF GetListaBusquedaRIF(string dato)
        {
            try
            {
                ...
                {
                    MySqlCommand OrdenSql = new MySqlCommand("busquedaPLUS", conn)
                    {
