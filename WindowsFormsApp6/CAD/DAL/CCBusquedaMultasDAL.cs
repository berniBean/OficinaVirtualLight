...
{
    public class CCBusquedaMultasDAL : obtenerBusquedaMultas
    {
        private readonly string strConn;

        public CCBusquedaMultasDAL()
        {
            strConn = System.Configuration.ConfigurationManager.AppSettings["K1"];
        }

        public CCBusquedaMultasDAL(string conn)
        {
            strConn = conn;
        }
        ...
        public ListaCBusquedaMultas GetListaBusquedaMultasRIF(string dato)
        {
            try
            {
                ...
                {
                    MySqlCommand OrdenSql = new MySqlCommand("busquedaMultas", conn)
                    {
