...
namespace WindowsFormsApp6.Helper.Strategy.Concretas
{
    internal class SpreadRequerimientoConDatos : AbstractProgress, IStrategyExcel<CListaRequeridosBO>
    {
        ...
        private async Task SpreadExeclProcessAsync(List<CListaRequeridosBO> listaRequerimientos, ExcelDataDto _datos, IProgress<int> progress = null)
        {
            ...
            #region Agregar color y bordes a tabla de excel
            ...
            try
            {
                ...
                string fileName = $"{_datos.LblEmision}_{sl.GetCurrentWorksheetName()} {_datos.CmbOHE}_{listaRequerimientos.Count}.xls";
