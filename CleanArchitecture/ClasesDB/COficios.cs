...
{
    public class COficios :  IControl,IControlOficios, IDirectorio, IFechaOficios,IOficinaHacienda, IZona,IFoliosMultas, IFoliosRequerimientos  
    {
        public COficios()
        {
        ...
        public COficios(int idOficio, string referencia, string zona, string oHE, int numOficio)
         {
             IdOficio = idOficio;
         ...
         public COficios(int idOficio, string referencia, string zona, string oHE, DateTime fechaEmision,
